...
insert into adm_user(id, email, username, password, is2fa_enabled, group_id, active, version, personal_info_id)
values (1, 'admin@gmail.com', 'admin',
        '$2a$10$FszQtoGSFc/WDJZvOUQiQeGhGiw7KwwXh7tMRbMBpUtYLE.PGmM/y', true, 1, true, 0, 1)
on conflict do nothing;
